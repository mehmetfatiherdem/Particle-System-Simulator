...
namespace persistence::utils
{
	...
	void serializeQuaternion(Serializer& serializer, glm::quat quaternion, const std::string& objectName = "");
	...
	void deserializeQuaternion(const Deserializer& deserializer, glm::quat* quaternion);
